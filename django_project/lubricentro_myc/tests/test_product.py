...
class ProductTestCase(TestCase):
    ...
    def test_search_by_detail(self):
        ...
        self.assertEqual(productos[0]["codigo_en_pantalla"], self.product_1.codigo_en_pantalla)
        self.assertEqual(productos[1]["codigo_en_pantalla"], self.product_4.codigo_en_pantalla)
    ...
    def test_search_by_category(self):
        ...
        self.assertEqual(productos[0]["codigo_en_pantalla"], self.product_2.codigo_en_pantalla)
        self.assertEqual(productos[1]["codigo_en_pantalla"], self.product_5.codigo_en_pantalla)
        self.assertEqual(productos[2]["codigo_en_pantalla"], self.product_6.codigo_en_pantalla)
